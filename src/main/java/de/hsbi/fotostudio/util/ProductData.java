...
public class ProductData implements Serializable{
     ...
     * category_list, storageStatus_list, billingType_list, product_list
     */
    @PostConstruct
    public void init() {
        ...
        product_list.add(new Product(0, "Analogbilder Drucken", "Drucken von einem eigenen Bildes als Analogbild", category_list.get(1), billingType_list.get(0), 8f, -1, storageStatus_list.get(0)));
        product_list.add(new Product(1, "Kalender Drucken", "Drucken von einem eigenen Kalender", category_list.get(1), billingType_list.get(2), 12.3f, -1, storageStatus_list.get(0)));
        product_list.add(new Product(2, "Bilder Drucken", "Drucken von einem einem Bild", category_list.get(1), billingType_list.get(0), 2.5f, -1, storageStatus_list.get(0)));
        product_list.add(new Product(3, "Poster Drucken", "Drucken von einem einem Poster", category_list.get(1), billingType_list.get(0), 5.5f, -1, storageStatus_list.get(0)));
        product_list.add(new Product(4, "Passbilder", "Erstellen von 4 Passbildern", category_list.get(1), billingType_list.get(1), 6f, -1, storageStatus_list.get(0)));
        product_list.add(new Product(5, "Familienbilder", "Familienbilder im eigenen Fotostudio erstellen", category_list.get(1), billingType_list.get(3), 32.5f, -1, storageStatus_list.get(1)));
        product_list.add(new Product(6, "Hochzeitsbilder", "Hochzeitbilder im eigenen Fotostudio erstellen", category_list.get(1), billingType_list.get(3), 50f, -1, storageStatus_list.get(0)));
        product_list.add(new Product(7, "Hochzeitsbilder", "Hochzeitbilder erstellen. Der Ort ist frei wählbar", category_list.get(2), billingType_list.get(3), 70, -1, storageStatus_list.get(1)));
        product_list.add(new Product(8, "Auftragsbilder Ort", "Professionelle Bilder von einem Ort", category_list.get(2), billingType_list.get(2), 60f, -1, storageStatus_list.get(0)));
        product_list.add(new Product(9, "Auftragsbilder Person", "Professionelle Bilder von einer Person", category_list.get(1), billingType_list.get(1), 60f, -1, storageStatus_list.get(2)));
        product_list.add(new Product(10, "Canon EOS 2000D", "Die Canon EOS 2000D Gehäuse ist eine vielseitige und benutzerfreundliche Spiegelreflexkamera, die sich perfekt für den angehenden Fotografen eignet.", category_list.get(3), billingType_list.get(2), 500.0f, 1, storageStatus_list.get(0)));
        product_list.add(new Product(11, "Objektive 18-55mm DC", "Canon EF-S 18–55 mm DC III ƒ/3,5-5,6:\n - Brennweite 29-88 mm\n - Kreisförmige Blende für gute Hintergrundunschärfe", category_list.get(3), billingType_list.get(2), 150.0f, 3, storageStatus_list.get(0)));
        product_list.add(new Product(12, "Objektive 75-300mm III", "Canon EF 75–300 mm ƒ/4-5,6 III:\n - Telezoomobjektiv\n - Minimale Blende: 32–45", category_list.get(3), billingType_list.get(2), 150.0f, 2, storageStatus_list.get(0)));
        product_list.add(new Product(13, "Canon EOS 250D", "Canon EOS 250D:\n - ISO 100-25.600 (erweiterbar auf 51.200)\n - Objektivanschluss: EF / EF-S", category_list.get(3), billingType_list.get(2), 450.0f, 0, storageStatus_list.get(2)));
